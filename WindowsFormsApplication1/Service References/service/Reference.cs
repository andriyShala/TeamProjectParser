...
namespace WindowsFormsApplication1.service {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="service.IParseService")]
    public interface IParseService {
        ...
        WindowsFormsApplication1.service.Vacancy[] GetVacancies(string Category, string City, string Site, int Day);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IParseService/GetVacancies", ReplyAction="http://tempuri.org/IParseService/GetVacanciesResponse")]
        System.Threading.Tasks.Task<WindowsFormsApplication1.service.Vacancy[]> GetVacanciesAsync(string Category, string City, string Site, int Day);
        ...
        WindowsFormsApplication1.service.Vacancy[] GetVacanciesBySearch(string NameVacancy, string Category, string City, string Site, int Day);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IParseService/GetVacanciesBySearch", ReplyAction="http://tempuri.org/IParseService/GetVacanciesBySearchResponse")]
        System.Threading.Tasks.Task<WindowsFormsApplication1.service.Vacancy[]> GetVacanciesBySearchAsync(string NameVacancy, string Category, string City, string Site, int Day);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IParseServiceChannel : WindowsFormsApplication1.service.IParseService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ParseServiceClient : System.ServiceModel.ClientBase<WindowsFormsApplication1.service.IParseService>, WindowsFormsApplication1.service.IParseService {
        ...
        public WindowsFormsApplication1.service.Vacancy[] GetVacancies(string Category, string City, string Site, int Day) {
            return base.Channel.GetVacancies(Category, City, Site, Day);
        }
        
        public System.Threading.Tasks.Task<WindowsFormsApplication1.service.Vacancy[]> GetVacanciesAsync(string Category, string City, string Site, int Day) {
            return base.Channel.GetVacanciesAsync(Category, City, Site, Day);
        }
        
        public WindowsFormsApplication1.service.Vacancy[] GetVacanciesBySearch(string NameVacancy, string Category, string City, string Site, int Day) {
            return base.Channel.GetVacanciesBySearch(NameVacancy, Category, City, Site, Day);
        }
        
        public System.Threading.Tasks.Task<WindowsFormsApplication1.service.Vacancy[]> GetVacanciesBySearchAsync(string NameVacancy, string Category, string City, string Site, int Day) {
